...
export function HomePage() {
  ...
  // Stan dla punktów użytkownika - przechowuje w localStorage
  const [userPoints, setUserPoints] = useState(() => {
    const saved = localStorage.getItem('userPoints');
    return saved ? parseInt(saved) : mockUser.points;
  });

  // Funkcja do zaktualizowania punktów
  ...
  const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (result.verified) {
        ...
        updateUserPoints(userPoints + dailyTask.points);
    ...
    <div className="home-page-new">
      ...
      <header className="home-header-new">
        ...
        <div className="points-badge-new">
          ...
          <span className="points-value-new">{userPoints}</span>
            ...
            <div className="ticket-options">
              <div className="ticket-type">
                ...
                <button className="ticket-btn">
                  ...
                  <span className="ticket-btn-price">4.40 zł</span>
                </button>
                <button className="ticket-btn">
                  <div className="ticket-btn-content">
                  ...
                  <span className="ticket-btn-price">2.20 zł</span>
                </button>
                <button className="ticket-btn">
                  <div className="ticket-btn-content">
                  ...
                  <span className="ticket-btn-price">5.60 zł</span>
                </button>
                <button className="ticket-btn">
                  <div className="ticket-btn-content">
                  ...
                  <span className="ticket-btn-price">2.80 zł</span>
                </button>
              </div>
